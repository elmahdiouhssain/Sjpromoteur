                    ...
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="breadcrumb-holder">
                                <h1 class="main-title float-left">Modification du amical
                                    {!! Form::open(['method' => 'DELETE','route' => ['amicals.destroy', $societe->id],'style'=>'display:inline']) !!}
                                    {!! Form::submit('Supprimé', ['class' => 'btn btn-danger btn-sm','onclick'=>"return confirm('Vous etes-sur supprimé l amical')"]) !!}
                                    {!! Form::close() !!}
                                </h1>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                            <div class="card mb-3">
                                ...
                                <div class="container">
                                {!! Form::model($societe, ['method' => 'PATCH','route' => ['amicals.update', $societe->id]]) !!}
                            <div class="row">
